...
<?php
       ...
       if(isset($_POST['submit'])){
        ...
        // requête d'ajout
        $sql ="insert into `ajoutercours` (titre,soustitre,description,imgcours) values ('$titre','$soustitre','$description','$imgcours')";
        ...
        <main>
            ...
            <div class="data">
                <div class="content-data">
                    ...
                    <p class="erreur_message" style="color: red; font-size: 14px;	font-family: 'Open Sans', sans-serif;margin-left:10px;	font-weight: 500;">
                    </p>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" name="description" placeholder="déscription...">
                        </div>

                        <div class="form-group">
                        <input type="file" name="imgcours">
                        </div>

                        <br>
                        <div class="form-group">
                            <button type="submit" class="btn-send" name="submit" ><i class='bx bxl-telegram'></i>&nbsp Enregistrer</button>
                        </div>
